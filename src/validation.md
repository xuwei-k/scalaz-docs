...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.2.10/core/src/main/scala/scalaz/Validation.scala)
- [scaladoc](https://oss.sonatype.org/service/local/repositories/releases/archive/org/scalaz/scalaz_2.12/7.2.10/scalaz_2.12-7.2.10-javadoc.jar/!/scalaz/Validation.html)
