...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.3.9/core/src/main/scala/scalaz/Validation.scala)
- [scaladoc](https://javadoc.io/doc/org.scalaz/scalaz_2.13/7.3.9/scalaz/Validation.html)
