...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.2.25/core/src/main/scala/scalaz/Either.scala)
- [scaladoc](https://static.javadoc.io/org.scalaz/scalaz_2.12/7.2.25/scalaz/$bslash$div.html)
