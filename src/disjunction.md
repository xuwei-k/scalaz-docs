...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.2.12/core/src/main/scala/scalaz/Either.scala)
- [scaladoc](https://oss.sonatype.org/service/local/repositories/releases/archive/org/scalaz/scalaz_2.12/7.2.12/scalaz_2.12-7.2.12-javadoc.jar/!/scalaz/$bslash$div.html)
