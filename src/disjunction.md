...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.3.4/core/src/main/scala/scalaz/Either.scala)
- [scaladoc](https://static.javadoc.io/org.scalaz/scalaz_2.13/7.3.4/scalaz/$bslash$div.html)
