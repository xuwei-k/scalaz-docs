...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-effect" % "7.2.20"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-iteratee" % "7.2.20"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-scalacheck-binding" % "7.2.20"
```
