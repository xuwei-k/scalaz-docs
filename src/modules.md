...
```scala mdoc:silent
libraryDependencies += "org.scalaz" %% "scalaz-effect" % "7.3.9"
```
...
```scala mdoc:silent
libraryDependencies += "org.scalaz" %% "scalaz-iteratee" % "7.3.9"
```
...
```scala mdoc:silent
libraryDependencies += "org.scalaz" %% "scalaz-scalacheck-binding" % "7.3.9"
```
