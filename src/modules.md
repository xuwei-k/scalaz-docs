...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-effect" % "7.2.21"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-concurrent" % "7.2.21"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-iteratee" % "7.2.21"
```
