...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-effect" % "7.2.15"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-iteratee" % "7.2.15"
```
...
```tut:silent
libraryDependencies += "org.scalaz" %% "scalaz-scalacheck-binding" % "7.2.15"
```
