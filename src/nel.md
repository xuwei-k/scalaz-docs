...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.3.5/core/src/main/scala/scalaz/NonEmptyList.scala)
- [scaladoc](https://static.javadoc.io/org.scalaz/scalaz_2.12/7.3.5/scalaz/NonEmptyList.html)
