...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.2.2/core/src/main/scala/scalaz/NonEmptyList.scala)
- [scaladoc](https://oss.sonatype.org/service/local/repositories/releases/archive/org/scalaz/scalaz_2.11/7.2.2/scalaz_2.11-7.2.2-javadoc.jar/!/index.html#scalaz.NonEmptyList)
