...
- [ソースコード](https://github.com/scalaz/scalaz/blob/v7.3.6/core/src/main/scala/scalaz/NonEmptyList.scala)
- [scaladoc](https://javadoc.io/doc/org.scalaz/scalaz_2.12/7.3.6/scalaz/NonEmptyList.html)
